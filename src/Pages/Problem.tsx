...
export default function Problem() {
    ...
    useEffect(() => {
        axios.post("http://localhost:8192/problem", {
            page : page,
            maxProblem : 10
    ...
    return (
        <div className="px-[5%] pt-[2%] text-[20px]">
            <h1 className="text-[40px] border-b-[1px] border-b-[#ccc] pb-[10px]">Bài Tập</h1>
            
            <table className="w-[70%] table-auto border-collapse text-center">
                <thead>
